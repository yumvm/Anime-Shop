...
- Сделать хорошую документацию к проекту
- Переделать систему карточек товаров, сделать по клику на карточку переход на отдельную страницу товара
- Реализовать отзывы и обсуждения товаров
- Обновлять и поддерживать документацию проекта
- .....
